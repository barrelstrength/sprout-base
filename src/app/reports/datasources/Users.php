...
class Users extends DataSource
{
    ...
    {
        return Craft::t('sprout', 'Create reports about your users and user groups.');
    }
    ...
    public function validateSettings(array $settings = [], array &$errors = []): bool
    {
        if (empty($settings['userGroups'])) {
            $errors['userGroups'][] = Craft::t('sprout', 'Select at least one User Group.');
