...
Craft.SproutForms.EntriesTableView = Craft.TableElementIndexView.extend({
    ...
    createChartExplorer: function() {
      ...
      const $chartExplorer = $('<div class="chart-explorer"></div>').appendTo(this.$explorerContainer),
        ...
        $totalLabel = $('<div class="total-label light">' + Craft.t('sprout', 'Total Submissions') + '</div>').appendTo($total),
    ...
    loadReport: function() {
      ...
      Craft.postActionRequest('sprout/charts/get-entries-data', requestData, $.proxy(function(response, textStatus) {
        ...
        if (textStatus === 'success' && typeof (response.error) === 'undefined') {
          ...
          let msg = Craft.t('sprout', 'An unknown error occurred.');
