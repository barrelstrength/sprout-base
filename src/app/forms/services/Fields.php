...
use barrelstrength\sproutbase\app\forms\fields\formfields\Address;
use barrelstrength\sproutbase\app\forms\fields\formfields\Categories;
use barrelstrength\sproutbase\app\forms\fields\formfields\Checkboxes;
use barrelstrength\sproutbase\app\forms\fields\formfields\CustomHtml;
use barrelstrength\sproutbase\app\forms\fields\formfields\Date;
use barrelstrength\sproutbase\app\forms\fields\formfields\Dropdown;
use barrelstrength\sproutbase\app\forms\fields\formfields\Email;
use barrelstrength\sproutbase\app\forms\fields\formfields\EmailDropdown;
use barrelstrength\sproutbase\app\forms\fields\formfields\Entries;
use barrelstrength\sproutbase\app\forms\fields\formfields\FileUpload;
use barrelstrength\sproutbase\app\forms\fields\formfields\Hidden;
use barrelstrength\sproutbase\app\forms\fields\formfields\Invisible;
use barrelstrength\sproutbase\app\forms\fields\formfields\MultipleChoice;
use barrelstrength\sproutbase\app\forms\fields\formfields\MultiSelect;
use barrelstrength\sproutbase\app\forms\fields\formfields\Name;
...
use barrelstrength\sproutbase\app\forms\fields\formfields\Paragraph;
use barrelstrength\sproutbase\app\forms\fields\formfields\Phone;
use barrelstrength\sproutbase\app\forms\fields\formfields\PrivateNotes;
use barrelstrength\sproutbase\app\forms\fields\formfields\RegularExpression;
use barrelstrength\sproutbase\app\forms\fields\formfields\SectionHeading;
use barrelstrength\sproutbase\app\forms\fields\formfields\SingleLine;
use barrelstrength\sproutbase\app\forms\fields\formfields\Tags;
use barrelstrength\sproutbase\app\forms\fields\formfields\Url;
use barrelstrength\sproutbase\app\forms\fields\formfields\Users;
...
class Fields extends Component
{
    ...
    {
        $standardLabel = Craft::t('sprout', 'Standard Fields');
        $specialLabel = Craft::t('sprout', 'Special Fields');
        $relationsLabel = Craft::t('sprout', 'Relations Fields');
    ...
    public function addDefaultTab(Form $form, &$field = null)
    {
        ...
        if ($field === null) {
            ...
            $field = $fieldsService->createField([
                ...
                'name' => Craft::t('sprout', 'Default Field'),
                'handle' => $handle,
                'instructions' => '',
    ...
    public function deleteTab(Form $form, FieldLayoutTabRecord $tabRecord): bool
    {
        ...
        if (count($fieldLayout->getTabs()) <= 1) {
            $tabRecord->addError('fieldLayoutId', Craft::t('sprout', 'Unable to delete page. One page required.'));
