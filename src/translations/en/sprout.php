...
Shorthand syntax: {title}',
    ...
    'Disable Upgrade to Pro Messaging' => 'Disable Upgrade to Pro Messaging',
    'Sprout plugins will display upgrade notices throughout the interface where features can be improved by updating to Pro. This can be handy when getting familiar with a plugin and can be disabled when you\'d prefer not to see the reminder.' => 'Sprout plugins will display upgrade notices throughout the interface where features can be improved by updating to Pro. This can be handy when getting familiar with a plugin and can be disabled when you\'d prefer not to see the reminder.',
    'Upgrade to Sprout Reports Pro' => 'Upgrade to Sprout Reports Pro',
    'Welcome to Sprout Reports' => 'Welcome to Sprout Reports',
    'Ridiculously flexible custom reports' => 'Ridiculously flexible custom reports',
    'Sprout Reports provides easy-to-use pre-defined and custom reports in Twig, MySQL, and PHP.' => 'Sprout Reports provides easy-to-use pre-defined and custom reports in Twig, MySQL, and PHP.',
    'Upgrade to PRO to use Custom Reports and Data Source integrations.' => 'Upgrade to PRO to use Custom Reports and Data Source integrations.',
    'Sprout will display upgrade notices throughout the interface where features can be improved by updating to Pro. This can be handy when getting familiar with our plugins and can be disabled using this setting if you\'d prefer not to see the reminder.' => 'Sprout will display upgrade notices throughout the interface where features can be improved by updating to Pro. This can be handy when getting familiar with our plugins and can be disabled using this setting if you\'d prefer not to see the reminder.',
    'Ramp up your Report Repetoire.' => 'Ramp up your Report Repetoire.',
    'Nuppp.' => 'Nuppp.',
    'Sprout plugins will display upgrade notices throughout the interface where features can be improved by updating to Pro. This can be handy when getting familiar with our plugins and can be disabled using this setting if you\'d prefer not to see the reminder.' => 'Sprout plugins will display upgrade notices throughout the interface where features can be improved by updating to Pro. This can be handy when getting familiar with our plugins and can be disabled using this setting if you\'d prefer not to see the reminder.',
    'Visualizations' => 'Visualizations',
    'Upgrade to Pro to use Custom Reports and Data Source integrations.' => 'Upgrade to Pro to use Custom Reports and Data Source integrations.',
    'Sprout Reports makes it easy to create pre-defined and custom reports in Twig, MySQL, and PHP.' => 'Sprout Reports makes it easy to create pre-defined and custom reports in Twig, MySQL, and PHP.',
    'Upgrade to Sprout Reports PRO to use Custom Reports and Data Source integrations.' => 'Upgrade to Sprout Reports PRO to use Custom Reports and Data Source integrations.',
    'Nope!' => 'Nope!',
    'The Email Column should reference a column that is returned by the report that provides a valid email address. The Email Column name is case sensitive and should exactly match the column name in the header of the report. If the value returned by the Email Column does not validate as an email, it will be ignored.' => 'The Email Column should reference a column that is returned by the report that provides a valid email address. The Email Column name is case sensitive and should exactly match the column name in the header of the report. If the value returned by the Email Column does not validate as an email, it will be ignored.',
    'Sprout Reports [pro] makes it easy to create unlimited pre-defined and custom reports in Twig, MySQL, and PHP, along with Visualizations for your reports and dashboard.' => 'Sprout Reports [pro] makes it easy to create unlimited pre-defined and custom reports in Twig, MySQL, and PHP, along with Visualizations for your reports and dashboard.',
    'Sprout plugins will display upgrade notices throughout the interface where features can be improved by updating to Pro. This can be handy when getting familiar with a plugin and can be disabled when you\'d prefer to no longer see the reminder.' => 'Sprout plugins will display upgrade notices throughout the interface where features can be improved by updating to Pro. This can be handy when getting familiar with a plugin and can be disabled when you\'d prefer to no longer see the reminder.',
    'Email Columsn' => 'Email Columsn',
    'Sprout plugins will display upgrade notices throughout the interface where features can be improved by updating to Pro. This can be handy when getting familiar with a plugin and can be disabled using this setting if you\'d prefer not to see the reminder.' => 'Sprout plugins will display upgrade notices throughout the interface where features can be improved by updating to Pro. This can be handy when getting familiar with a plugin and can be disabled using this setting if you\'d prefer not to see the reminder.',
    ...
    'Create a [{listTypeName}]({newSubscriberList}) and your lists will display here in the sidebar.' => 'Create a [{listTypeName}]({newSubscriberList}) and your lists will display here in the sidebar.',
    'All lists' => 'All lists',
    ...
    'Double \'Oh\'. Reporting for duty!' => 'Double \'Oh\'. Reporting for duty!',
    ...
    'Recent Form Entries (Sprout)' => 'Recent Form Entries (Sprout)',
    ...
    'Upgrade to Sprout Sent Email PRO to manage Resend Emails.' => 'Upgrade to Sprout Sent Email PRO to manage Resend Emails.',
    'Manage lists and subscribers' => 'Manage lists and subscribers',
    ...
    'Double \'Oh!\' Seven. Reporting for duty.' => 'Double \'Oh!\' Seven. Reporting for duty.',
    'Unable to delete list.' => 'Unable to delete list.',
    'Create Subscriber List Automatically' => 'Create Subscriber List Automatically',
    'Upgrade to Sprout SEO PRO to enable multiple Metadata field mappings, manage redirects' => 'Upgrade to Sprout SEO PRO to enable multiple Metadata field mappings, manage redirects',
    'Unable to save list.' => 'Unable to save list.',
    'Form Integrations Log (Sprout)' => 'Form Integrations Log (Sprout)',
    'List Two' => 'List Two',
    'Unable to save subscriber.' => 'Unable to save subscriber.',
    'Upgrade to Sprout Reports PRO to enable unlimited custom reports, mailing list integrations, and visualizations' => 'Upgrade to Sprout Reports PRO to enable unlimited custom reports, mailing list integrations, and visualizations',
    'List Name' => 'List Name',
    ...
    'Double &lquo;Oh&rquo;\'. Reporting for duty!' => 'Double &lquo;Oh&rquo;\'. Reporting for duty!',
    'Reporting to duty.' => 'Reporting to duty.',
    'Aye, aye. Reporting for duty!' => 'Aye, aye. Reporting for duty!',
    'Upgrade to Sprout SEO PRO to enable multiple Metadata field mappings, manage redirects, and generate sitemaps.' => 'Upgrade to Sprout SEO PRO to enable multiple Metadata field mappings, manage redirects, and generate sitemaps.',
    'Form Notification (Sprout)' => 'Form Notification (Sprout)',
    'Unable to delete Subscriber.' => 'Unable to delete Subscriber.',
    'Name (Sprout)' => 'Name (Sprout)',
    'Form Entries (Sprout)' => 'Form Entries (Sprout)',
    ...
    'When a form entry is saved (Sprout)' => 'When a form entry is saved (Sprout)',
    'Subscriber Lists' => 'Subscriber Lists',
    'List Three' => 'List Three',
    'Couldn’t delete campaign email.' => 'Couldn’t delete campaign email.',
    'Subscriber List (Sprout Lists)' => 'Subscriber List (Sprout Lists)',
    'Edit List' => 'Edit List',
    'Predefined (Sprout)' => 'Predefined (Sprout)',
    'Enable User Sync' => 'Enable User Sync',
    'Subscriber deleted.' => 'Subscriber deleted.',
    'Double “Oh”. Reporting for duty!' => 'Double “Oh”. Reporting for duty!',
    'List(s) deleted.' => 'List(s) deleted.',
    'List deleted.' => 'List deleted.',
    'Upgrade to Sprout Redirects PRO to manage Unlimited Redirects.' => 'Upgrade to Sprout Redirects PRO to manage Unlimited Redirects.',
    'Default Message' => 'Default Message',
    'Predefined Date (Sprout)' => 'Predefined Date (Sprout)',
    'Subscriber List' => 'Subscriber List',
    'Learn&nbsp;more' => 'Learn&nbsp;more',
    'List saved.' => 'List saved.',
    'Upgrade to Sprout Reports PRO to enable unlimited custom reports, mailing list integrations, and visualizations.' => 'Upgrade to Sprout Reports PRO to enable unlimited custom reports, mailing list integrations, and visualizations.',
    'Subscriber(s) deleted.' => 'Subscriber(s) deleted.',
