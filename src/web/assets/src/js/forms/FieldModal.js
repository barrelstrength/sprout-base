...
(function($) {
  ...
  Craft.SproutForms.FieldModal = Garnish.Modal.extend({
      ...
      init: function(settings) {
        ...
        Craft.postActionRequest('sprout/form-fields/modal-field', postData, $.proxy(function(response, textStatus) {
      ...
      saveField: function(e) {
        ...
        Craft.postActionRequest('sprout/form-fields/save-field', data, $.proxy(function(response, textStatus) {
      ...
      editField: function(id) {
        ...
        Craft.postActionRequest('sprout/form-fields/edit-field', data, $.proxy(function(response, textStatus) {
          this.$loadSpinner.addClass('hidden');
      ...
      deleteField: function(e) {
        ...
        if (userResponse) {
          ...
          Craft.postActionRequest('sprout/form-fields/delete-field', data, $.proxy(function(response, textStatus) {
            const statusSuccess = (textStatus === 'success');

            if (statusSuccess && response.success) {

              Craft.cp.displayNotice(Craft.t('sprout', 'Field deleted.'));
              ...
              Craft.cp.displayError(Craft.t('sprout', 'Unable to delete field.'));
